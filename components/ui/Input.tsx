...
export const Input = ({
  ...
  return (
    <View>
      ...
      <TextInput
        style={[
          tw`flex h-10 w-full items-center rounded-md text-black dark:text-dark-foreground border border-input dark:border-dark-input bg-red-200 px-3 py-2 text-sm leading-[0px]`,
